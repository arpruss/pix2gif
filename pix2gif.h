...
#define wordswap(a)   (a=((a<<8)&0xff00)|((a>>8)&0x00ff))

/* Header component offsets */
#define H_PART		0
#define H_FLAGS		1
#define H_LOCAL_COUNT	4
#define H_GLOBAL_PTR	6
#define H_ENTRY_SIZE	8
#define H_CHECKSUM	10
#define H_VERSION	14
#define H_REVERSE	16
...
typedef struct header_s {
    ...
    unsigned short local_count;
    unsigned short global_ptr;
